...
This document will run the Causal Forecasting MVDLM model on simulated data similar to the data in Tierney et al. (2023). The MVDLM is implemented in python and run via the `reticulate` R package. Python 3.9 is required to simulate from multivariate $t$ distributions. 
