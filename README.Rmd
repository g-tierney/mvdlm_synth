...
Next, we show how to call the main workhorse function `mv_synth` to run the analysis. The main class is implemented in `mvdlm/mvdlm.py`. The `mv_synth` function automates much of the analysis process by automating prior construction and getting the relevant forecast results.  
